...
echo '<script>alert("Branch Successfully");</script>';
            }
...
?>
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="bname" placeholder="Enter  Name" required>
                  </div>
                                            <div class="form-group col-md-6 input_fields_number">
                                                   <label for="exampleInputEmail1">Email*</label>
                    <input  class="form-control" onchange="return email(event)"  type="email" name="bemail"  placeholder="Enter  Email" required>
                            </div>
                                        </div>
                      ...
                      ?>
                      <option value="<?=$cq['name']?>"><?=$cq['name']?></option>
                      <?php
}
                      ?>
                    </select>
                    ...
                    <input  class="form-control"  id="txtPhoneNo" type="number" name="amount"   required>
                            </div>
                                      <div class="form-group col-md-6 input_fields_number">
