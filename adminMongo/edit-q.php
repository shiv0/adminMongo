...
echo '<script>alert("Qualification Updated Successfully");
   window.location="view-qualification.php";
...
foreach ($cursor as $doc) {
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="qname" placeholder="Enter Qualification" required value="<?=$doc["qname"]?>">
