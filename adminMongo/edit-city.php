...
$collection->updateOne(["_id"=>new MongoDB\BSON\ObjectID($id)], 
      ['$set'=>["cname"=>$cname,"state"=>$state]]);
   // $collection->insertOne($document);
   //echo "Document inserted successfully";
echo '<script>alert("City Updated Successfully");
   window.location="view-mcity.php";
...
foreach ($cursor as $doc) {
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="cname" placeholder="Enter City  Name" required value="<?=$doc["cname"]?>">
