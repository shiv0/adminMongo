...
echo '<script>alert("Qualification Registered Successfully");</script>';
            }
?>
 ...
 <div class="row" style="width:900px;">
                        <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4>Qualification  Registration</h4>
                                        </div>                                                                        
                                    </div>
                                </div>
                    ...
                    <label for="exampleInputEmail1">Qualification Name*</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="qname" placeholder="Enter Qualification  Name" required>
                  </div>
