...
$collection->updateOne(["email"=>$id], 
      ['$set'=>["name"=>$uname,"lname"=>$lname,"email"=>$uemail,"mobile"=>$umobile,"password"=>$upass,"qualification"=>$uqua,"address"=>$uaddress,"district"=>$dis,"state"=>$ustate,"pin"=>$upincode]]);
...
foreach ($cursor as $doc) {
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="uname" placeholder="Enter User Name" required value="<?=$doc['name']?>">
                  </div>
                           
                                            <div class="form-group col-md-6 input_fields_number">
                                                   <label for="exampleInputEmail1">User Last Name*</label>
                    <input  class="form-control"   type="text" name="lname"  placeholder="Enter User Last Name" required value="<?=$doc['lname']?>">
                            </div>
                                        </div>

                                           <div class="row">
                                           <div class="form-group col-md-12 input_fields_number">
                                                   <label for="exampleInputEmail1">User Email*</label>
                    <input  class="form-control" onchange="return email(event)"  type="email" name="uemail"  placeholder="Enter User Email" required value="<?=$doc['email']?>">
                            </div>
                    ...
                    <input  class="form-control"  type="number" name="umobile"  placeholder="Enter User Mobile" required value="<?=$doc['mobile']?>">
                            </div>
                                            <div class="form-group col-md-6 input_fields_number">
                      ...
                      ?>
                      <option value="<?=$cq['qname']?>" <?php if($doc['qualification']==$cq['qname']) { echo 'selected';}?>><?=$cq['qname']?></option>
                      <?php
}
                      ?>
                    </select>
                    ...
                    <select class="form-control" name="state" id="ustate">
                      <?php
                    ...
                    <select class="form-control" name="dis" id="udis">
                      ...
                      ?>
                      <option value="<?=$cdata['_id']?>"><?=$cdata['cname']?></option>
                      <?php
}
                      ?>
                    </select>
                    ...
                    <input  class="form-control"  id="txtPhoneNo" type="number" name="upincode"  placeholder="Enter Pincode" required value="<?=$doc['pin']?>">
                            </div>
                                       <div class="form-group col-md-6 input_fields_number">
                                                   ...
                                                   {
                                                   ?>
                    <input  class="form-control"  type="text"   placeholder="Enter User Category" required value="Teacher" readonly="">
<?php
}else{
  ?>
   <input  class="form-control"  type="text"   placeholder="Enter User Category" required value="Branch Head" readonly="">
  <?php
}
                       ?>     </div>
                                        </div>
