...
?>
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input  class="form-control" onchange="return email(event)"  type="email" name="cemail"  placeholder="Enter  Email" required>
                            </div>
                                        </div>
                    ...
                    <input  class="form-control"  id="txtPhoneNo" type="text" name="subject"  placeholder="Enter Subject" required>
                            </div>
                                         <div class="form-group col-md-6 input_fields_number">
                                                   <label for="exampleInputEmail1">Duration*</label>
                    <input  class="form-control"  id="txtPhoneNo" type="text" name="duration"  placeholder="Enter Duration" required>
                            </div>
                                        </div>
                    ...
                    <input  class="form-control"  id="txtPhoneNo" type="date" name="sdate"   required>
                            </div>
                                        <div class="form-group col-md-6 input_fields_number">
                                                   <label for="exampleInputEmail1">Amount*</label>
                    <input  class="form-control"  id="txtPhoneNo" type="number" name="amount" placeholder="Enter Amount"   required>
                            </div>
                    ...
                    <input  class="form-control"  type="text" name="desc" placeholder="Enter Description"   required>
                            </div>
