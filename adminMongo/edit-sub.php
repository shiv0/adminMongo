...
foreach ($cursor as $doc) {
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="sname" placeholder="Enter Subject  Name" required value="<?=$doc["name"]?>">
