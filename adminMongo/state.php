...
echo '<script>alert("State Registered Successfully");</script>';
            }
?>
 ...
 <div class="row" style="width:900px;">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="sname" placeholder="Enter State  Name" required>
                  </div>
